...
void SetLogDir(std::string logdir);
  ...
  static void SetGlobalLogDir(const std::string& logdir);
  static void SetGlobalCeLevels(NbIotRrcSap::NprachParametersNb ce0,
                                NbIotRrcSap::NprachParametersNb ce1,
                                NbIotRrcSap::NprachParametersNb ce2);
  static void SetGlobalNprachFormat(int format);  // 1 = Format 1 (3.75 kHz), 2 = Format 2 (1.25 kHz)
protected:
  ...
  int m_nprachFormat = 2;  // 1 = Format 1 (3.75 kHz, CP 266 us), 2 = Format 2 (1.25 kHz, CP 800 us)
  uint64_t m_frameNo;
  ...
  std::string m_logdir;
  static std::string s_globalLogDir;
  static bool s_ceLevelsSet;
  static NbIotRrcSap::NprachParametersNb s_ce0;
  static NbIotRrcSap::NprachParametersNb s_ce1;
  static NbIotRrcSap::NprachParametersNb s_ce2;
  static int s_nprachFormat;  // 1 or 2, default 2
//std::vector<std::pair<uint64_t,uint64_t>> GetAllPossibleSearchSpaceCandidates(std::vector<uint64_t> subframes, uint64_t R_max);
  ...
  void LogRarRepetitions(const NbIotRrcSap::NpdcchMessage& msg, const SearchSpaceConfig& ssc);
};
